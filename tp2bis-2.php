...
<html lang="en">
  ...
  <body>
		<form method="get" action="tp2bis-2.php" enctype="encodage">
    <table border=1>
      <?php
    $data = array(
    ...
    ?>
      ...
      <\tr>
        ...
        foreach($data as $line){
					if($co > ($pageactuelle*$parpage) && $co <(($pageactuelle*$parpage)+$parpage)){
   ...
   <\table>
		<table border=1>
			<tr>
				<th><a href="?pageactuelle=<?php if ($pageactuelle>0) echo $pageactuelle-1?>">precedent</a></th>
				<th><a href="?pageactuelle=0">1</a></th>
				<th><a href="?pageactuelle=1">2</a></th>
				<th><a href="?pageactuelle=2">3</a></th>
				<th><a href="?pageactuelle=3">4</a></th>
				<th><a href="?pageactuelle=4">5</a></th>
				<th><a href="?pageactuelle=<?php if ($pageactuelle<4) {echo $pageactuelle+1;} else { echo $pageactuelle;} ?>">suivant</a></th>
			</tr>
		 </table>
		 </form>
  </body>
